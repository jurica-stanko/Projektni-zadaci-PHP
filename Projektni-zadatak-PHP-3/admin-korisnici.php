...
//uređivanje profila forma
    ...
    while ($_redak = mysqli_fetch_array($_rezultat)) {
        ...
        if ($redak['drzava'] == $_redak['numcode']) {
            print ' selected';
        }
    ...
    echo ' /> NE
            <br>
            <label for="korPravo">Korisničko pravo?</label>
            <br>
            <input type="radio" name="korPravo" value="A"';
    if ($redak['korPrava'] == 'A') {
        echo ' checked="checked"';
        $arhiva_checked = TRUE;
    }
    echo ' /> Admin &nbsp;&nbsp;
			<input type="radio" name="korPravo" value="K"';
    if ($redak['korPrava'] == 'K') {
        echo ' checked="checked"';
    }
    echo ' /> Korisnik &nbsp;&nbsp;
            <input type="radio" name="korPravo" value="E"';
    if ($redak['korPrava'] == 'E') {
        echo ' checked="checked"';
    }
    echo ' /> Editor
