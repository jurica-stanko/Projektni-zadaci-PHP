<?php
    ...
    if (isset($action) && $action != '') {
        ...
        $_rezultat = mysqli_query($baza, $_upit);
			...
			<div class="wrapper">'; 
                while($_redak = mysqli_fetch_array($_rezultat)){
                    print '
						<figure>
							<img src="galerija/' . $_redak['naziv'] . '" alt="' . $redak['naziv'] . '" title="' . $redak['naziv'] . '"' . ' class = "news-slika">
						</figure>';
                }
            print '
			</div>
		...
		while($redak = mysqli_fetch_array($rezultat)) {
			...
			print '
			<div class="clanci">
				<img src="galerija/' . $_redak['naziv'] . '" alt="' . $redak['naziv'] . '" title="' . $redak['naziv'] . '"' . ' class = "clanak_thumbnail">
				<h2>' . $redak['naziv'] . '</h2>';
